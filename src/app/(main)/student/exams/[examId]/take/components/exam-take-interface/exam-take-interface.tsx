...
import { SaveStatusIndicator } from '@/app/(main)/student/exams/[examId]/take/components/save-status-indicator/save-status-indicator'
import { DraftRestoredBanner } from '@/app/(main)/student/exams/[examId]/take/components/draft-restored-banner/draft-restored-banner'
import { NetworkStatusBanner } from '@/app/(main)/student/exams/[examId]/take/components/network-status-banner/network-status-banner'
