...
import ExamHeader from '@/app/(main)/exam/components/exam-header/exam-header'
import QuestionList from '@/app/(main)/exam/components/question-list/question-list'
import ExamEditor from '@/app/(main)/exam/components/exam-editor/exam-editor'
import ExamBottomPanel from '@/app/(main)/exam/components/exam-bottom-panel/exam-bottom-panel'
...
import { ExamWatermark } from '@/app/(main)/exam/components/exam-watermark/exam-watermark'
...
import styles from '@/app/(main)/exam/components/exam-interface/exam-interface.module.scss'
...
export default function ExamInterface({
  ...
  if (loading) {
    return <div className={styles.loadingContainer}>Đang tải phiên thi...</div>
  }
  if (error) {
